...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/28 15:27:13 by lkoletzk          #+#    #+#             */
/*   Updated: 2023/03/29 10:18:37 by lkoletzk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	Create a child process. Stop everything on failure.
	pid = fork();
	if (pid == -1)
	{
		perror("fork");
	...
	else if (pid == 0) // Child process working
	{
